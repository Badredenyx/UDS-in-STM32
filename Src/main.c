...
int main(void)
{
    ...
    while (1)
    {
        // L'application principale peut effectuer d'autres t�ches si n�cessaire
    }
...
void GPIO_Init(void)
{
    ...
    // Configurez d'autres GPIO si n�cessaire
}
...
void UART2_Init(void)
{
    ...
    {
        Error_handler(); // Gestion d'erreur si l'initialisation �choue
    }
}
